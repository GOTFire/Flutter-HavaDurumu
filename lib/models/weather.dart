...
class Weather {
  ...
  factory Weather.fromMap(Map<String, dynamic> json) => Weather(
    consolidatedWeather: json["consolidated_weather"] == null ? null : List<ConsolidatedWeather>.from(json["consolidated_weather"].map((x) => ConsolidatedWeather.fromMap(x))),
    ...
    sources: json["sources"] == null ? null : List<Source>.from(json["sources"].map((x) => Source.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
    "consolidated_weather": consolidatedWeather == null ? null : List<dynamic>.from(consolidatedWeather.map((x) => x.toMap())),
